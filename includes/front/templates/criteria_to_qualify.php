...
<div class="criteriaToQualifyFormWrapper">
	...
	<form id="criteriaToQualifyForm">
		<div class="row">
			<div class="col-12">
				<div class="form-group">
					<label for="ctqTV">
						<div class="checkWr">
							<input type="checkbox" id="ctqTV">
						</div>
				...
				<div class="form-group">
					...
					<div class="text-center">
						<button class="cssecoBtn animationbtn" type="submit">				
							Submit
						</button>
					</div>
				</div>
