...
<form id="cssecoReferralForm">
	...
	<div class="row">
		<div class="col-12 col-md-6 pr-md-1 col-xl-2">
		...
		<div class="col-12 col-md-6 pl-md-1 col-xl-2 pr-xl-1">
			<div class="form-group">
		...
		<div class="col-12 col-md-12 col-xl-3 pl-xl-1 pr-xl-1">
			<div class="form-group">
		...
		<div class="col-12 col-md-6 pr-md-1 col-xl-2 pl-xl-1">
			<div class="form-group">
		...
		<div class="col-12 col-md-6 pl-md-1 col-xl-3">
			<div class="form-group">
				<label for="phonenumber">Phone</label>
				<div class="phoneFP clearfix">
					<input id="phoneprefix" class="form-control phoneprefixclass phone-prefix" type="text" name="phone_country_code" value="" readonly="">
	...
	<div class="row">
		<div class="col-12 col-md-6 pr-md-1 col-xl-2">
			<div class="form-group">
				...
				<input type="text" id="ffname" class="form-control" placeholder="Friend's First Name" name="fFname" />
				<i class="fas fa-check isValid"></i>
				<i class="fas fa-times isError"></i>
			</div>
		</div>
		...
		<div class="col-12 col-md-6 pl-md-1 col-xl-2 pr-xl-1">
			<div class="form-group">
				...
				<input type="text" id="flsname" class="form-control" placeholder="Friend's Last Name" name="fLname"  />
				<i class="fas fa-check isValid"></i>
				<i class="fas fa-times isError"></i>
			</div>
		</div>
		<div class="col-12 col-md-12 col-xl-3 pl-xl-1 pr-xl-1">
			<div class="form-group">
				...
				<input type="email" id="femail" class="form-control" placeholder="Friend's Email" name="fEmail"  />
				<i class="fas fa-check isValid"></i>
				<i class="fas fa-times isError"></i>
			</div>
		</div>
		<div class="col-12 col-md-6 pr-md-1 col-xl-2 pl-xl-1">
			<div class="form-group">
				...
				<select name="fcountry" id="fcountry" class="location_city_input form-control jcf-hidden">
    					<option id="choose" value="" data-prefix="">
    					Select Prefix
    					</option>
    					<option id="AF" value="93" data-country="AF">
		...
		<div class="col-12 col-md-6 pl-md-1 col-xl-3">
			<div class="form-group phoneFP clearfix">
				...
				<div class="phoneFP clearfix">
					<input id="fphoneprefix" class="form-control phoneprefixclass phone-prefix" type="text" name="f_phone_country_code" value="" readonly="">
					<input id="fphonenumber" class="form-control phonenumberclass phone-number" name="fphonenumber" type="tel" placeholder=" Friend's Phone">
					<i class="fas fa-check isValid"></i>
    				<i class="fas fa-times isError"></i>
				</div>
			</div>
	...
	<div class="row">
		<div class="col-12 col-md-12 col-xl-8">
			<div class="form-group text-center">
				...
				<textarea class="form-control " id="refmessage" name="referral_message" rows="6" placeholder="Enter your message here..."></textarea>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-12">
			<div class="form-group m-3 text-center text-md-center">
				<button type="submit" name="submit_referral" id="submit-referral" class="cssecoBtn animationbtn">Submit</button>
			</div>
		</div>
	</div>
</form>