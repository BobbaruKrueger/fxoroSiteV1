...
<script src="https://cdn.jsdelivr.net/npm/libphonenumber-js@1.7.19/bundle/libphonenumber-max.js"></script>
<script>
	...
	$('#cssecoContactForm').validate({
		...
		$('#submit').on( 'click', (e)=>{
			...
			if ( $('#cssecoContactForm').valid() ){
				let url = '<?php echo get_template_directory_uri().'/includes/front/templates/process_contact_form.php';?>';
				let fname = $('#fname').val();
				let lname = $('#lname').val();
				let email = $('#email').val();
