...
/**
 * @package fxoroVone
 * includes/front/templates/trading_conditions/tabs/floating.php
 *
 * FLOATING
 */
?>
	...
	<div class="tab-pane fade show active" id="professional" role="tabpanel" aria-labelledby="professional-tab">
		...
		<div class="tab-content">
			<div class="tab-pane active" id="fxp" role="tabpanel" aria-labelledby="fxp-tab">
				<!-- Professional - FX-->
				<?php 
					include( locate_template( 'includes/front/templates/trading_conditions/tabs/tables/professional_fx_floating.php', false, false ) );
				?>
			</div>
			<div class="tab-pane" id="cfdsp" role="tabpanel" aria-labelledby="cfdsp-tab">
				<!-- Professional - CFD's-->
				<?php 
					include( locate_template( 'includes/front/templates/trading_conditions/tabs/tables/professional_cfds_floating.php', false, false ) );
				?>
			</div>
			<div class="tab-pane" id="stocksp" role="tabpanel" aria-labelledby="stocksp-tab">
				<!-- Professional - Stocks-->
				<?php 
					include( locate_template( 'includes/front/templates/trading_conditions/tabs/tables/professional_stocks_floating.php', false, false ) );
				?>
			</div>
			<div class="tab-pane" id="cryptocurrenciesp" role="tabpanel" aria-labelledby="cryptocurrenciesp-tab">
				...
				<?php 
					include( locate_template( 'includes/front/templates/trading_conditions/tabs/tables/professional_crypto_floating.php', false, false ) );
				?>
			</div>
		</div>
	</div>
	<div class="tab-pane fade" id="retail" role="tabpanel" aria-labelledby="retail-tab">
		...
		<div class="tab-content">
			<div class="tab-pane active" id="fxr" role="tabpanel" aria-labelledby="fxr-tab">
				<!-- Retail - FX-->
				<?php 
					include( locate_template( 'includes/front/templates/trading_conditions/tabs/tables/retail_fx_floating.php', false, false ) );
				?>
			</div>
			<div class="tab-pane" id="cfdsr" role="tabpanel" aria-labelledby="cfdsr-tab">
				<!-- Retail - CFD's-->
				<?php 
					include( locate_template( 'includes/front/templates/trading_conditions/tabs/tables/retail_cfds_floating.php', false, false ) );
				?>
			</div>
			<div class="tab-pane" id="stocksr" role="tabpanel" aria-labelledby="stocksr-tab">
				<!-- Retail - Stocks-->
				<?php 
					include( locate_template( 'includes/front/templates/trading_conditions/tabs/tables/retail_stocks_floating.php', false, false ) );
				?>
			</div>
			<div class="tab-pane" id="cryptocurrenciesr" role="tabpanel" aria-labelledby="cryptocurrenciesr-tab">
				<!-- Professional - Crypto Currencies-->
				<?php 
					include( locate_template( 'includes/front/templates/trading_conditions/tabs/tables/retail_crypto_floating.php', false, false ) );
				?>
			</div>
		</div>
	</div>
